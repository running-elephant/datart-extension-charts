(function () {
  ...
  function LifeExpectancyChart({ dHelper }) {
    const mockData = {
      data: {
        counties: [
          "China",
    ...
    return {
      ...
      getOptions(dataset, config) {
            ...
            visualMap: [
              {
                show: false,
                dimension: 3,
                categories: mockData.data.counties,
                inRange: {
                  color: (function () {
                    var colors = [
                      "#51689b",
        ...
        for (var n = 0; n < mockData.data.timeline.length; n++) {
          option.baseOption.timeline.data.push(mockData.data.timeline[n]);
          option.options.push({
            title: {
              show: true,
              text: mockData.data.timeline[n] + "",
            },
            series: {
              name: mockData.data.timeline[n],
              type: "scatter",
              itemStyle: itemStyle,
              data: mockData.data.series[n],
              symbolSize: function (val) {
                return sizeFunction(val[2]);
              },
            },
